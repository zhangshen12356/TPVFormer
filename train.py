...
if __name__ == '__main__':
    ...
    parser.add_argument('--py-config', default='config/tpv04_occupancy_swinT.py')
    parser.add_argument('--work-dir', type=str, default='./out/tpv04_occupancy_swinT')
    parser.add_argument('--resume-from', type=str, default='/home/zs/Code/TPVFormer_new/out/tpv04_occupancy_swinT/epoch_1.pth')
